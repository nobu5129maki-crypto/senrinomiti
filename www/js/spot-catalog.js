...
export const MINOR_SPOT_ENTRIES = [
  ...
  { id: 'zuiganji', name: '瑞巌寺', lat: 38.3708, lng: 141.0611, mode: 'japan', img: 'matsushima', aliases: ['松島瑞巌寺', 'ずいがんじ'] },
  ...
  { id: 'goshogawara-nebuta', name: 'ねぶたの家', lat: 40.8228, lng: 140.7472, mode: 'japan', img: 'aomoriNebuta', aliases: ['五所川原', '立佞武多'] },
  ...
  { id: 'matterhorn', name: 'マッターホルン', lat: 45.9763, lng: 7.6586, mode: 'world', img: 'neuschwanstein', aliases: ['matterhorn', 'ツェルマット', 'スイス'] },
  ...
  { id: 'ephesus', name: 'エフェソス', lat: 37.9390, lng: 27.3410, mode: 'world', img: 'hagiaSophia', aliases: ['ephesus', 'トルコ', '古代遺跡'] },
  ...
  { id: 'florence-duomo', name: 'フィレンツェ大聖堂', lat: 43.7731, lng: 11.2560, mode: 'world', img: 'leaningTowerPisa', aliases: ['florence', 'ドゥオモ', 'フィレンツェ'] },
  { id: 'venice', name: 'ヴェネツィア', lat: 45.4408, lng: 12.3155, mode: 'world', img: 'amsterdamCanal', aliases: ['venice', 'サン・マルコ', 'イタリア'] },
  ...
  { id: 'blue-lagoon', name: 'ブルーラグーン', lat: 63.8804, lng: -22.4495, mode: 'world', img: 'amsterdamCanal', aliases: ['blue lagoon'] },
  { id: 'reine', name: 'レーヌ', lat: 67.9333, lng: 13.0833, mode: 'world', img: 'amsterdamCanal', aliases: ['reine', 'ロフォーテン', 'ノルウェー'] },

  // ── 海外：アジア・中東 ──
  { id: 'angkor-wat', name: 'アンコールワット', lat: 13.4125, lng: 103.8670, mode: 'world', img: 'angkorWat', aliases: ['angkor wat', 'シェムリアップ', 'カンボジア'] },
  { id: 'bagan', name: 'バガン', lat: 21.1717, lng: 94.8585, mode: 'world', img: 'angkorWat', aliases: ['bagan', 'ミャンマー', '仏塔'] },
  ...
  { id: 'wadi-rum', name: 'ワディ・ラム', lat: 29.5833, lng: 35.4167, mode: 'world', img: 'petra', aliases: ['wadi rum', 'ヨルダン'] },
  ...
  { id: 'uyuni', name: 'ウユニ塩湖', lat: -20.1338, lng: -67.4891, mode: 'world', img: 'machuPicchu', aliases: ['uyuni', 'ボリビア', '塩湖'] },
  ...
  { id: 'banff', name: 'バンフ国立公園', lat: 51.4968, lng: -115.9281, mode: 'world', img: 'niagaraFalls', aliases: ['banff', 'カナダ', 'レイクルイーズ'] },
  ...
  { id: 'quebec-old', name: 'ケベック旧市街', lat: 46.8139, lng: -71.2080, mode: 'world', img: 'cnTower', aliases: ['quebec', 'カナダ', '旧市街'] },
  ...
  { id: 'great-barrier-reef', name: 'グレートバリアリーフ', lat: -18.2871, lng: 147.6992, mode: 'world', img: 'guam', aliases: ['great barrier reef', 'オーストラリア', '珊瑚礁'] },
  { id: 'cartagena', name: 'カルタヘナ', lat: 10.3910, lng: -75.4794, mode: 'world', img: 'christRedeemer', aliases: ['cartagena', 'コロンビア', '旧市街'] },
  { id: 'galapagos', name: 'ガラパゴス諸島', lat: -0.9538, lng: -90.9656, mode: 'world', img: 'christRedeemer', aliases: ['galapagos', 'エクアドル'] },
  { id: 'atacama', name: 'アタカマ砂漠', lat: -24.5000, lng: -69.2500, mode: 'world', img: 'machuPicchu', aliases: ['atacama', 'チリ'] }
];
